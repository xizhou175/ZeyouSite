...
class Academy(models.Model):
    ...
    # 产品类型
    product_type = models.CharField(max_length=64, db_index=True)

    # 分配助教
    teaching_assistant = models.CharField(max_length=64, db_index=True)

    # 所属销售人员
    sales = models.CharField(max_length=64, db_index=True)

    # 授课老师
    teacher = models.CharField(max_length=64, db_index=True)

    # 购买时间
    date_of_purchasing = models.DateField(db_index=True, default=datetime.utcnow)  # timezone?

    # 产品内容
    product = models.CharField(max_length=64, db_index=True)

    # 上课日期
    date_of_lecture = models.DateField(db_index=True)

    # 预计课时
    hours_of_lecture = models.IntegerField()

    # price/hour
    price_per_hour = models.IntegerField()

    # price
    price_overall = models.IntegerField()

    # 推进状态
    cur_state = models.CharField(max_length=64, db_index=True)
